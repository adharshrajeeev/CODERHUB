...
function Conversation() {
    return (
        <Stack height={"100%"} maxHeight={"100vh"} width={"auto"} overflow={"hidden"}>
            {/* {CHAT HEADER} */}
            <Box p={2} sx={{ height: 50, width: "100%", backgroundColor: "#d8e3ff", boxShadow: "0px 0px 2px rgba(0,0,0,0.25)" }}>
            ...
            {/* {CHAT FOOTER} */}
            <Box p={2} sx={{  width: "auto", backgroundColor: "#d8e3ff", boxShadow: "0px 0px 2px rgba(0,0,0,0.25)" }}>
